 ...
 * @author Lenovo
 */
public class calendarioDeFunciones extends javax.swing.JFrame {

    /**
     * Creates new form inicio2
     */
    public calendarioDeFunciones() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 20, 230, 40));

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("CALENDARIO DE FUNCIOINES:");
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 350, 100, 40));

        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("AQUI DEBE IR EL CALENDARIO DE LAS FUNCIONES , PERO ESO SE HARA CON EL JCALENDAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(calendarioDeFunciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new calendarioDeFunciones().setVisible(true);
            }
        });
    }
